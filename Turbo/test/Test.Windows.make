...
TESTOBJS	:= ./../obj/Debug/source/extern/time.o ./../obj/Debug/source/extern/directory.o
DEPENDS		:= $(OBJECTS:%.o=%.d)
...
$(OUT): $(OBJECTS)
	...
	@echo ======================
	@$(CC) $(CPPFLAGS) $(CCFLAGS) $(OBJECTS) $(TESTOBJS) -o $(OUT) $(INCD) $(LIBD) $(LDFLAGS)
	@echo =======================
